...
public class PufferfishJavaEntityInstance<T extends PufferfishBedrockEntityInstance> extends MobJavaEntityInstance<T>
{
	public PufferfishJavaEntityInstance(@NotNull String bedrockEntityIdentifier, @NotNull T bedrockEntityInstance)
	{
	...
	protected void onMetadataFieldChanged(@NotNull EntityMetadata<?, ? extends MetadataType<?>> metadata)
	{
		...
		{
			this.bedrockEntityInstance.pufferfishSize = value;
		});
	}
}